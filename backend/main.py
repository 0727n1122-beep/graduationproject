...
{{
  ...
  "issues": [
    {{
      ...
      "field": "MISSING_CONSTRAINT일 때만: 빠진 조건이 무엇인지 (예: '출력 언어', '코드 형식'). 다른 카테고리는 null",
      "suggested_value": "MISSING_CONSTRAINT일 때만: 추천 값 (예: 'Python 3.12'). 확신 없으면 null. 다른 카테고리는 null"
    }}
  ]
}}
...
- field/suggested_value는 MISSING_CONSTRAINT 카테고리에서만 값을 채우고, 나머지 카테고리에서는 반드시 null로 둘 것.
